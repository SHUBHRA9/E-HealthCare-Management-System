...
public class ReceptionDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(280, 0, 310, 40);
        ...
        jButton3.setBounds(590, 0, 305, 40);
        ...
        jTextField2.setBounds(800, 270, 240, 30);
        ...
        jButton5.setBounds(620, 180, 320, 40);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Recep_Id", "Fname", "Lname", "Age", "Gender", "Address", "Phone", "City/State", "Uname", "Password"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(0, 600, 1550, 170);
        ...
        jLabel12.setBounds(0, 0, 1550, 780);
        ...
        setSize(new java.awt.Dimension(1570, 824));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            int a=st.executeUpdate("DELETE FROM `receptionist` WHERE `Receptionist_Id`='"+s1+"'");
            if(a==1)
            {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?user=root&password=");
            Statement st=con.createStatement();
            int a=st.executeUpdate("UPDATE `receptionist` SET `Receptionist_Id`='"+s1+"',`Fname`='"+s1+"',`Lname`='"+s1+"',`Age`='"+s1+"',`Gender`='"+s1+"',`Address`='"+s1+"',`Phone`='"+s1+"',`City_State`='"+s1+"',`Uname`='"+s1+"',`Password`='"+s1+"' WHERE `Receptionist_Id`='"+s1+"'");
            if(a==1)
            {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?user=root&password=");
            Statement st=con.createStatement();
            int a=st.executeUpdate("INSERT INTO `receptionist` VALUES('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"')");
            if(a==1)
            {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?user=root&password=");
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("SELECT * FROM receptionist WHERE Receptionist_Id='"+s1+"'");
            while(rs.next()){
