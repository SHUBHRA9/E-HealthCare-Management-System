 ...
 * @author HP
 */
public class DeptDetails extends javax.swing.JFrame {

    /**
     * Creates new form DeptDetails
     */
    public DeptDetails() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(280, 0, 320, 40);
        ...
        jButton3.setBounds(600, 0, 330, 40);
        ...
        jButton4.setBounds(930, 0, 300, 40);
        ...
        jButton6.setText("SEARCH DEPARTMENT");
        ...
        jButton6.setBounds(800, 270, 320, 40);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Dept_Number", "Dept_Name", "Dept_Description"
            }
        ));
        ...
        jScrollPane1.setBounds(40, 580, 1380, 180);
        ...
        setSize(new java.awt.Dimension(1511, 822));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            int a=st.executeUpdate("INSERT INTO `department` VALUES('"+s1+"','"+s2+"','"+s3+"')");
            if(a==1)
            {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?user=root&password=");
            Statement st=con.createStatement();
            int a=st.executeUpdate("DELETE FROM department WHERE `Dept_Id`='"+s1+"'");
            if(a==1)
            {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?user=root&password=");
            Statement st=con.createStatement();
            int a=st.executeUpdate("UPDATE `department` SET `Dept_Id`='"+s1+"',`Dept_NAME`='"+s2+"',`Dept_Desc`='"+s3+"' WHERE `Dept_Id`='"+s1+"'");
            if(a==1)
            {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/hms?user=root&password=");
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("SELECT * FROM department WHERE Dept_Id='"+s1+"'");
            while(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeptDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeptDetails().setVisible(true);
            }
        });
    }
